...
public class Deney7Ipucu : MonoBehaviour
{
    ...
    {
        panel.SetActive(true);
        text.text = "Bilmediğin veya önem verdiğin kağıtları panoya asıp diğer kağıtları da çöpe atabilirsin. Kağıtların renklerini kendin seçebildiğini unutma !";
