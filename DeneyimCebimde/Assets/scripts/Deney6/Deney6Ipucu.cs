...
public class Deney6Ipucu : MonoBehaviour
{
    string[] ipucular = { "Kişinin oturuşunu düzeltmek için sırtına dokun", "Yemek konusunda tercihini sağlıklı yemekten yana kullan.", "Bilgisayarı uzaklaştır." };
